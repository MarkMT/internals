...
If not, Merb runs the bootloader and starts the Rack adapter. This pid file requirement
...
location from the command line or in the startup script you may use

...
many various ways to "understand" the information contained inside. A "whatever
works", or "pragmatic" approach will go a long way.
...
fact, why don't you go there right now, fork the repository and clone it to your
...
you and go with that, listen to your Inner Mentor(tm)... whatever, go!
...
the stages with references to the pieces of the source code. 
It may be helpful to you to refer to this picture again as you read through this
handbook.
